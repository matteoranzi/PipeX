...
class Integer final : public Data_ {
public:
    int value = 0;
...
class Float final : public Data_ {
public:
    float value = 0.0f;
...
int main() {
    ...
    std::vector<std::unique_ptr<Data_>> dataset;
    ...
    const Data_* element = dataset[0].get();

...
24. **make_unique:** [Exception-Safe Function Calls - Herb Sutter's Blog](https://herbsutter.com/gotw/_102/)
...
25. **Copilot:** (https://github.com/copilot/)) - Strumento di supporto alla scrittura del codice basato su AI.
...
> Gli strumenti di AI (ChatGPT e Copilot) sono stati utilizzati esclusivamente per suggerimenti di refactoring, miglioramento della leggibilità del codice e generazione di commenti/documentazione. Tutta la logica, il design e l'implementazione sono stati realizzati autonomamente dall'autore del progetto.
